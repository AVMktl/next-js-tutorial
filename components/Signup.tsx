...
export function Signup() {
    ...
    return <div className="relative">
        {loading ? <div className="bg-slate-400 opacity-80 absolute bg-opacity-50 text-5xl flex justify-center items-center inset-0"> <Puff
        visible={true}
        height="100"
        width="100"
        color="#353935"
        ...
        <a href="#" className="block max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 ">
                <div>
                    ...
                    <div className="pt-2">
                        ...
                        }} label="Username" type={"email"} placeholder="harkirat@gmail.com" />
                        <LabelledInput onChange={(e) => {
